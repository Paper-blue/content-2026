---
title: '训练一个大模型的电够 4 万户家庭用一年，剑桥想让 AI 学会省电'
subtitle: '开关电流低了100万倍，能耗砍掉70%，但离量产还很远'
date: 2026-04-26
cover: './附件/cover.jpg'
images:
  - './附件/section1.jpg'
...
训练一个 **GPT-4** 级别的大模型要烧掉大约 **50 吉瓦时**的电，够 **4 万户**中国家庭用一整年。IEA 的数据说 2024 年全球数据中心用电 **415 太瓦时**，AI 占了 **53 到 76 太瓦时**，到 2028 年可能翻到 **326 太瓦时**。说白了，现在限制 AI 往前跑的最大瓶颈就一个字：电。
...
那你可能会问，类脑芯片是不是就只是实验室里的玩具？也不完全是。Intel 的 **Hala Point** 系统已经部署在桑迪亚国家实验室了，有 **11.5 亿个**仿神经元，在持续学习类的任务上展示了比 GPU 高 **5600 倍**的能效优势。2025 年 4 月有团队把大语言模型跑在了 Intel 的 **Loihi 2** 类脑芯片上，准确率跟同等 GPU 版本差不多，但能耗只有一半。这些实验室级别的成果说明方向是对的，但距离替代 GPU 成为 AI 的主力算力底座，还隔着好几代技术迭代和一整个产业生态的重建。
...
莱特兄弟1903年第一次飞了12秒，离地不到三米，当时所有正经工程师都说这玩意儿没实用价值——12秒能干什么？但问题从来不是12秒能干什么，而是12秒证明了一件事：比空气重的东西可以飞。剑桥这块忆阻器大概就是类脑计算的那个12秒，它证明的不是"能用"，是"能省"，至于什么时候能从12秒飞到跨大西洋，中间差的不只是技术，是整个航空工业。
